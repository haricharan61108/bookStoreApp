...
function Navbar() {
    //to enable dark mode functionality
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer ml-6">Book Store</a>
  </div>

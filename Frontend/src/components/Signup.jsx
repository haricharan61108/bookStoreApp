...
function Signup() {
  ...
  <div className="modal-box">
    ...
    <div className='flex justify-around mt-6'>
        ...
        <span className='mt-1'>Have account? <button className='underline  text-blue-500 cursor-pointer'  onClick={()=> document.getElementById("my_modal_3").showModal()}>Login</button></span>
        <Login></Login>
    </div>
    </form>
  </div>
